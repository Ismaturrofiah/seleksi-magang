...
use App\Models\InternSelectionTechnicalRejectModel;

use CodeIgniter\RESTful\ResourceController;
use CodeIgniter\API\ResponseTrait;

class InternSelectionInterviewReject extends ResourceController
{
    ...
    public function create()
    {
        ...
        $adm = new InternSelectionTechnicalRejectModel();
